...
(3, 9, 1, 2, NULL, NULL, 2),
(4, 10, 1, NULL, 'true', NULL, -1),
(8, 9, 3, 4, NULL, NULL, 4),
(9, 10, 3, NULL, 'true', NULL, -1),
(10, 9, 9, 1, NULL, NULL, 1),
(11, 10, 9, NULL, 'false', NULL, -1),
(12, 11, 1, 4, NULL, NULL, 4),
(13, 12, 1, NULL, 'true', NULL, -1);
...
--
ALTER TABLE `labs`
  MODIFY `labID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
...
--
ALTER TABLE `students_on_courses`
  MODIFY `socID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--

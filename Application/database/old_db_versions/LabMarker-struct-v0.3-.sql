...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2017 at 12:55 PM
...
ALTER TABLE `course_lecturer`
  ...
  ADD KEY `Course Exists` (`lecturer`);
...
ALTER TABLE `course_lecturer`
  ...
  ADD CONSTRAINT `Lecturer Exists` FOREIGN KEY (`lecturer`) REFERENCES `user_details` (`detailsId`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `lab_helpers`
  ADD CONSTRAINT `User Exists` FOREIGN KEY (`userRef`) REFERENCES `user_details` (`detailsId`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `students_on_courses`
  ...
  ADD CONSTRAINT `studentExists` FOREIGN KEY (`student`) REFERENCES `user_details` (`detailsId`) ON DELETE CASCADE ON UPDATE CASCADE;

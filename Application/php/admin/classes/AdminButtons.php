...
class AdminButtons extends Admin
{
    ...
    public function panelButtons()
    {
        ...
        $buttons .= $this->buttonLayout( "Manage Database", "manageDatabaseButton()");

        return json_encode(array("layout"=>$buttons));
    }


    public function manageDatabaseButton()
    {
    ...
    {
        return "<button type='button' class='btn btn-$type admin-panel-btn col-md-6 col-sm-6 col-xs-12 col-md-offset-3 col-sm-offset-3' onclick='$action'>$text</button>";
    }
